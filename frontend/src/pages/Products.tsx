...
// import { PiSolarPanelBold } from "react-icons/pi";
// import { GiSteelClaws } from "react-icons/gi"; // 👈 NEW
...
// import { GiSteelClaws } from "react-icons/gi";
// import { 
//   Battery, Zap, Search, SunMedium, Package, 
//   Cable, CircuitBoard, Palette, LayoutList, Grid 
// } from 'lucide-react';
// import { Navbar } from '@/components/Navbar';
// import axios from 'axios';
...
// type ProductFamily = "ALL" | "ONGRID" | "HYBRID" | "BATTERY" | "MODULES" | "ACCESSORIES" | "MOUNTING" | "BOS";
// type ViewMode = 'grid' | 'list';
...
//       const gstNo = localStorage.getItem(`${company}_gstin`);

//       const res = await axios.post(
//         `${BACKEND_URL}/api/product/list?company=${company}`,
//         { gstNo },
//         {
//           headers: {
...
//                     animate={{ opacity: 1, y: 0 }}
//                     transition={{ delay: index * 0.05 }}
//                     className={`bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow ${viewMode === 'list' ? 'p-4' : ''}`}
//                   >
//                     <div className={viewMode === 'list' ? 'flex items-center justify-between' : 'p-6'}>
//                       <div className="flex items-center gap-4">
//                         <div className={`p-3 rounded-lg ${
...
//                           {viewMode === 'list' && (
//                             <p className="text-sm text-gray-500 mt-1">
//                               Type: {productTypeInfo[product.type as keyof typeof productTypeInfo]?.label}
//                             </p>
//                           )}
//                           <p className="text-sm text-gray-500 mt-1 font-bold">
//                             Quantity: {product.quantity}
