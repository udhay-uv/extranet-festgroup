            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className={`w-64 pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-${companyMap[company as keyof typeof companyMap].color}-500`}
                />
              </div>
              <div className="flex gap-2 bg-gray-100 p-1 rounded-lg">
                <button
