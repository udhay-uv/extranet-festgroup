...
export function SemiconRegister() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(`${BACKEND_URL}/api/s/register`, {
        gstNo,
        name,
        password,
        email,
        ...
        <div className="text-center">
          ...
          >
            <p className="text-sm text-gray-600">
              ...
              <Link to="/s/login" className="font-medium text-green-600">
                Sign in
              </Link>
            </p>
          </motion.div>
