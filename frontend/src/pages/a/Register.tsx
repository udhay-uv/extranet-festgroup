...
export function FestaRegister() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(`${BACKEND_URL}/api/a/register`, {
        gstNo,
        name,
        password,
        email,
      ...
      >
        <Card className="p-8">
          <div className="text-center">
            ...
            >
              <img src="/A.png" alt="festa" height={60} width={200} />
            </motion.div>
            <motion.h2
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            <p className="text-sm text-gray-600">
              ...
              <Link to="/a/login" className="font-medium text-blue-600">
                Sign in
              </Link>
            </p>
          </motion.div>
