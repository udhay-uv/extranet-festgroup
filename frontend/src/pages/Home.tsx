      ...
      >
        <div className={`bg-white rounded-lg shadow-lg p-6 border border-${companyMap[company as keyof typeof companyMap].color}-100`}>
          ...
          <motion.div 
            ...
            animate={{ x: 0 }}
          >
            <h3 className={`text-xl font-semibold text-${companyMap[company as keyof typeof companyMap].color}-600 mb-4`}>Company Details</h3>
            <table className="w-full">
              <thead className="bg-blue-50">
                <tr>
                  <th className="px-4 py-2 text-left text-${companyMap[company as keyof typeof companyMap].color}-600">GST No.</th>
                  <th className="px-4 py-2 text-left text-${companyMap[company as keyof typeof companyMap].color}-600">Name</th>
            
                  <th className="px-4 py-2 text-left text-${companyMap[company as keyof typeof companyMap].color}-600">Sales Person</th>
                </tr>
              </thead>
              <tbody>
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h3 className={`text-xl font-semibold text-${companyMap[company as keyof typeof companyMap].color}-600`}>Address Types</h3>
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className={`bg-gradient-to-br from-${companyMap[company as keyof typeof companyMap].color}-50 to-white border-${companyMap[company as keyof typeof companyMap].color}-200`}>
                  <DialogHeader>
                    <DialogTitle className="text-2xl font-bold text-${companyMap[company as keyof typeof companyMap].color}-700">Add New Address</DialogTitle>
                  </DialogHeader>
                  <AddressForm
            ...
            <div className="flex justify-between items-center mb-6">
              <Button
                variant="outline"
                className={`w-full ${activeTab === 'Billing' ? `bg-${companyMap[company as keyof typeof companyMap].color}-600 text-white` : `bg-white text-${companyMap[company as keyof typeof companyMap].color}-600`}`}
              ...
              <Button
                variant="outline"
                className={`w-full ${activeTab === 'Shipping' ? `bg-${companyMap[company as keyof typeof companyMap].color}-600 text-white` : `bg-white text-${companyMap[company as keyof typeof companyMap].color}-600`}`}
              ...
              {filteredAddress?.map((type, index) => (
                ...
                >
                  <button
                    ...
                    className={`w-full bg-white border border-${companyMap[company as keyof typeof companyMap].color}-200 rounded-lg p-4 flex items-center justify-between hover:bg-${companyMap[company as keyof typeof companyMap].color}-50 transition-colors`}
                  >
                            ...
                            >
                              <div className="flex justify-between items-start">
                                ...
                                <Dialog>
                                  ...
                                  <DialogContent className={`bg-gradient-to-br from-${companyMap[company as keyof typeof companyMap].color}-50 to-white border-${companyMap[company as keyof typeof companyMap].color}-200`}>
                                    <DialogHeader>
                                      <DialogTitle className={`text-2xl font-bold text-${companyMap[company as keyof typeof companyMap].color}-700`}>Update Address</DialogTitle>
                                    </DialogHeader>
                                    <AddressForm 
